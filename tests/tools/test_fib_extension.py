...
from sk_fx.tools.fib_extension import FibExtension
from sk_fx.utils.test_utils import is_acceptable_error


@pt.mark.fib_extension
class TestCalculationFibExtension:
    """
    Class for testing for calculation logic of fibonacci extension
    """

    def test_case_USOIL_downtrend_extension(self):
        """
        Test extension for USOIL market
